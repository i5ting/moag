...
/**
 * Created by Moajs on June 8th 2016, 10:45:22 am.
 */
...
exports.create = function *(ctx, next) {
  ...
  let student = yield Student.createAsync({name: req.body.name,password: req.body.password});
...
exports.update = function *(ctx, next) {
  ...
  let student = yield Student.updateById(id,{name: req.body.name,password: req.body.password});
...
exports.api = {
  ...
  update: function *(ctx, next) {
    ...
    let student = yield Student.updateByIdAsync(id, {name: req.body.name,password: req.body.password});
